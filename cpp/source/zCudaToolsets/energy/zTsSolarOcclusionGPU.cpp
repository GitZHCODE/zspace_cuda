...
namespace zSpace
{
	...
	ZSPACE_INLINE void zTsSolarOcclusionGPU::setBuffer(float* _bPositions, int* _bVals, int _numBuffer)
	{
	...
	ZSPACE_INLINE int* zTsSolarOcclusionGPU::getRawBufferValues()
	{
		return bufferValues;
	}
