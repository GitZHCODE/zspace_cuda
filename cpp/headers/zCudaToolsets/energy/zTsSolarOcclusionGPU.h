...
namespace zSpace
{
	...
	class ZSPACE_CUDA zTsSolarOcclusionGPU
	...
	public:
		...
		*/
		...
		//	//--------------------------	
		//		   
		ZSPACE_CUDA_CALLABLE_HOST void setBuffer(float* _bPositions, float* _bVals, int _numBuffer);
		...
		ZSPACE_CUDA_CALLABLE float* getRawBufferValues();
